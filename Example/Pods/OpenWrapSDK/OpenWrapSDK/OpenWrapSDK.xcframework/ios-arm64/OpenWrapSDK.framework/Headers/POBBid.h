 ...
 */
@property (nonatomic, readonly) NSNumber *grossPrice;
...
/*!
 @abstract Bid type. Value is YES for static bid & NO for dynamic bid. This is to be set by static bidder while creating the bid object
 
 */
@property (nonatomic, readwrite) BOOL hasStaticPrice;
