...
/*!
 Defines configuration for an ad
 */
@interface POBAdConfiguration : NSObject
/*!
 @abstract Initializes a configuration for a given ad type
 @param adType Ad type to initialize configuration for
 @result instance of POBAdConfiguration
*/
+ (instancetype)configurationForAdType:(POBAdType)adType;
/*!
 @abstract Initializes a configuration for a given ad type
 @param adType Ad type to initialize configuration for
 @param partnerExtras custom data for partners
 @result instance of POBAdConfiguration
*/
+ (instancetype)configurationForAdType:(POBAdType)adType
                         partnerExtras:(NSDictionary<NSString*,id<POBPartnerExtra>> *)partnerExtras;
...
/*!
 Returns partner extras for a partner id
 @param partnerId partner id
 @return partner extras object for the partnerId
 @see POBPartnerExtra
 */
- (id<POBPartnerExtra>)partnerExtraForPartner:(POBBidderId*)partnerId;

@property (nonatomic, assign) POBAdType adType;
